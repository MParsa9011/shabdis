...
const navItems = [
  ...
  { href: "/admin/analytics", label: "آمار فروش", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
  ...
  { href: "/admin/coupons", label: "کدهای تخفیف", icon: "M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" },
  { href: "/admin/messages", label: "پیام‌های تماس", icon: "M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" },
    ...
    <div className="flex h-screen bg-gray-50" dir="rtl">
      ...
      <aside className="w-56 bg-navy flex flex-col shrink-0">
        <div className="p-4 border-b border-white/10">
          <Link href="/">
            <Image src="/logo.png" alt="شبدیس" width={110} height={38} className="h-9 w-auto brightness-200" />
          </Link>
